...
export const createLandRecord = async (req: Request, res: Response) => {
  try {
...
export const getLandRecord = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const downloadLandRecordCertificatePDF = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const downloadLandRecordCertificateJPG = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
